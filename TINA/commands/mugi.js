...
if(!mention) return api.sendMessage("ওয়াহিদ বস কাকে চুদা লাগবে @ম্যানশন🙈", event.threadID);
...
setTimeout(() => {a({body: "আমি তোর বাপ ওয়াহিদ যেইখানে দেখবি সেইখানে দিবি সালাম🫡👹 🐰" + " " + name, mentions: arraytag})}, 7000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি ওয়াহিদ বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "Hi ওয়াহিদ জারজ মাগির পোলা 💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: Hi ওয়াহিদ এর জারজ পোলা মাগির পোলা 💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("ওয়াহিদ তোর বাপ লাগে পুত। জা ভাগ🤖")} , 39000);
