	...
	async function adduser(id, name) {
		...
		if (participantIDs.includes(id)) return out(`${name ? name : "Member"} জিঁলাঁপিঁ বস  মেমবার টা গ্রুপে এ্যাড রহিছে \n✢━━━━━━━━━━━━━━━✢\n ----❖----- WAHID -----❖----.`);
			...
			try {
				...
				return out(`ওয়াহিদ বস ${name ? name : "user"} এ্যাড করতে পারলাম না 😔😔 \n✢━━━━━━━━━━━━━━━✢\n ----❖----- WAHID-----❖---- .`);
			}
			if (approvalMode === true && !admins.includes(botID)) return out(`Add ${name ? name : "member"} ওয়াহিদ বস approved লিষ্টে জমা  দিয়েছি \n✢━━━━━━━━━━━━━━━✢\n ----❖----- WAHID -----❖----!`);
			else return out(`ওয়াহি বস ${name ? name : "member"} গ্রুপে এ্যাড করতে সফল্য \n✢━━━━━━━━━━━━━━━✢\n ----❖----- WAHID -----❖----!`)
		}
	}
    }
